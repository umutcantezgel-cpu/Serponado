...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    name: "Ahmet Y.",
    role: "Analyst 24/7 Core-Update-Taskforce",
    department: "Core-Update-Taskforce",
  ...
  },
  {
    ...
    name: "Sven W.",
    role: "Analyst Core-Update-Taskforce & Content-Cannibalizationen",
    department: "Core-Update-Taskforce",
  ...
  },
  {
    ...
    department: "Technik",
    bio: "Felix lernt das SEO des Data-Recoveryers von der Pike auf. Unter Aufsicht der Einsatzleiter begleitet er Core-Update-Taskforcee und lernt die Feinmechanik moderner HochSichtbarkeitsAudit kennen.",
