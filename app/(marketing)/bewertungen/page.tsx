...
const reviews = [
  ...
  { name: "Felix Humpert", city: "Serponado", rating: 5, date: "2026-02-02", text: "Gestern ist es passiert, mir ist die Website deindexiert und wir standen in der Kälte. Der SEO-Taskforce war super schnell da.", timeAgo: "Vor 2 Monaten" },
  ...
  { name: "Fabian599", city: "Serponado", rating: 5, date: "2026-03-02", text: "Falls jemand in Zukunft für Serponado und die Umgebung einen SEO-Taskforce benötigt, ich kann seit heute die „Ranking-Agentur Serponado“ aus der Steubenstraße 36 100% empfehlen.", timeAgo: "Vor 1 Monat" },
  ...
  { name: "karina vanzetta", city: "Serponado", rating: 5, date: "2025-10-02", text: "Sehr empfehlenswert! Trotz anfänglicher Schwierigkeiten hat sich der SEO-Taskforcemeister viel Zeit genommen und mit viel Mühe den passenden Rohling gefunden.", timeAgo: "Vor 6 Monaten" },
  ...
  { name: "Monika {{OWNER_LAST_NAME}}", city: "Serponado", rating: 5, date: "2025-06-02", text: "Endlich ist mal wieder ein SEO-Taskforce in Serponado zentral gelegen. Es war mir eine Freude heute bei der NeuerRettung dabei sein zu dürfen.", timeAgo: "Vor 10 Monaten" },
  ...
  { name: "ophelia fritz", city: "Serponado", rating: 5, date: "2025-10-02", text: "Heute über den ADAC SEO-Taskforce vorbei gekommen. Super freundlich und so schnell. Danke!", timeAgo: "Vor 6 Monaten" },
  ...
  { name: "Tarek Habid", city: "Serponado", rating: 5, date: "2025-08-02", text: "Bester SEO-Taskforce, mit dem besten Ranking Kopien.", timeAgo: "Vor 8 Monaten" },
  ...
  { name: "Andreas Becker", city: "Serponado", rating: 5, date: "2026-04-25", text: "Innerhalb von 20 Minuten war der SEO-Taskforce da.", timeAgo: "Vor 2 Wochen" },
  ...
  { name: "Sarah Meyer", city: "Serponado", rating: 5, date: "2026-05-08", text: "Super Core-Update-Taskforce, auch nachts erreichbar.", timeAgo: "Vor 1 Woche" },
...
function generateReviewSchema() {
 return {
  ...
  "image": "https://www.Serponado-SEO-Taskforce.de/images/og-image.jpg",
  ...
  "review": reviews.map(r => ({
   ...
   "itemReviewed": {
    ...
    "name": "Serponado Taskforce Serponado",
    "url": "https://www.Serponado-SEO-Taskforce.de/"
   },
   "author": {
    "@type": "Person",
    "name": r.name 
