...
"[project]/components/monitoring/ErrorHandlers.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$monitoring$2f$error$2d$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/monitoring/error-logger.ts [app-client] (ecmascript)");
...
function ErrorHandlers() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ErrorHandlers.useEffect": ()=>{
            const handleError = {
                "ErrorHandlers.useEffect.handleError": (event)=>{
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$monitoring$2f$error$2d$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["errorLogger"].capture(event.error || new Error(event.message), {
                        category: "client",
                        page: window.location.pathname
                    });
                }
            }["ErrorHandlers.useEffect.handleError"];
            const handleRejection = {
                "ErrorHandlers.useEffect.handleRejection": (event)=>{
                    const error = event.reason instanceof Error ? event.reason : new Error(String(event.reason));
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$monitoring$2f$error$2d$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["errorLogger"].capture(error, {
                        category: "client",
                        page: window.location.pathname
                    });
                }
            }["ErrorHandlers.useEffect.handleRejection"];
...
_s(ErrorHandlers, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = ErrorHandlers;
var _c;
__turbopack_context__.k.register(_c, "ErrorHandlers");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/monitoring/ErrorHandlers.tsx [app-client] (ecmascript, next/dynamic entry)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/components/monitoring/ErrorHandlers.tsx [app-client] (ecmascript)"));
}),
...
//# sourceMappingURL=_56261dca._.js.map